...
<div class="sticky" class:isStuck on:stuck={(e) => (isStuck = e.detail.isStuck)} use:sticky={{ stickToTop: true }}>
    <div class="sticky-container container">
        <div class="nav">
            <span class="logo" class:logo-visible={isStuck}>
                <svg id="logo_svg__Layer_1" x="0" y="0" viewBox="0 0 70 70" xml:space="preserve">
                    <style>
                        .logo_svg__st1 {
                            fill: #fff;
                        }
            ...
            {#each itemTypes as type}
                <a class="nav__link" href="/#{type.name}">{type.name}</a>
            {/each}
