<header>
    <div class="container header">
        <div class="left">
            <svg class="logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 532.32 97.95">
                <g>
                    <path
                        fill="#ff6900"
            ...
            <div class="contacts">
                <a class="contact-telephone" href="tel:+78003020060">8 800 302-00-60</a>
                <span class="contacts__label">Звонок бесплатный</span>
            </div>
        </div>
        <div class="right">
            <a href="https://youtu.be/dQw4w9WgXcQ" class="dodo-coins-link">
                <svg class="icon" width="24" height="24" viewBox="0 0 24 24" fill="#000">
                    <path
                        fill-rule="evenodd"
                        clip-rule="evenodd"
...
<style>
    ...
    .dodo-coins-link__label {
        transition: color 0.1s ease-in-out;
    }
    .dodo-coins-link:hover .dodo-coins-link__label {
        color: orange;
    }
