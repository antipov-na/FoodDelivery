<script>
    import ColumnNav from './UI/ColumnNav/ColumnNav.svelte';
    import Column from './UI/ColumnNav/Column.svelte';
</script>
    ...
    <div class="container footer-container">
        <div class="left">
            <ColumnNav
                ...
                --column-max-width="225px"
                --column-gap="60px"
                --links-gap="9px"
                --border-radius="10px"
            >
                <Column>
                    <h3 class="header" slot="header">О нас</h3>
                    <li><a class="link" href="http://">Додо-книга</a></li>
                    <li><a class="link" href="http://">Блог "Сила ума"</a></li>
                    <li><a class="link" href="http://">Додо ИС</a></li>
                </Column>
                <Column>
                    <h3 class="header" slot="header">Работа</h3>
                    <li><a class="link" href="http://">В пиццерии</a></li>
                    <li><a class="link" href="http://">В контакт-центре</a></li>
                </Column>
                <Column --column-max-width="160px">
                    <h3 class="header" slot="header">Франшиза</h3>
                    <li><a class="link" href="http://">Инвестиции</a></li>
                    <li><a class="link" href="http://">Поставщикам</a></li>
                    <li><a class="link" href="http://">Предложить помещение</a></li>
                </Column>
                <Column>
                    <h3 class="header" slot="header">Это интересно</h3>
                    <li><a class="link" href="http://">Почему мы готовим без перчаток?</a></li>
                    <li><a class="link" href="http://">Экскурсии и мастер-классы</a></li>
                    <li><a class="link" href="http://">Корпоративные заказы</a></li>
                </Column>
            </ColumnNav>
        </div>
        ...
        <div class="right">
            <div class="app-container">
                <a href="https://youtu.be/dQw4w9WgXcQ">
                    <img src="/img/app-store.svg" alt="" srcset="" />
                </a>
                <a href="https://youtu.be/dQw4w9WgXcQ">
                    <img src="/img/google-play.svg" alt="" srcset="" />
                </a>
                <a href="https://youtu.be/dQw4w9WgXcQ">
                    <img src="/img/app-galery.svg" alt="" srcset="" />
                </a>
            </div>
            <div class="contacts">
                <a class="contacts__phone-number" href="tel:+78003020060">8 800 302-00-60</a>
                <span class="contacts__phone-descriprion">Звонок бесплатный</span>
                <a class="contacts__email" href="mailto:feedback@dodopizza.com">feedback@dodopizza.com</a>
            </div>
        </div>
        <div class="bottom">
            <div class="copyright">
