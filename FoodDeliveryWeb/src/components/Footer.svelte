    ...
    <div class="container footer-container">
        <div class="top">
            <div class="left">
                <div class="footer__column">
                    <h3 class="footer__header">Додо Пицца</h3>
                    <ul class="footer__list">
                        <li class="footer__list-item">
                            <a class="list-item__link" href="https://youtu.be/dQw4w9WgXcQ">О нас </a>
                        </li>
                        <li class="footer__list-item">
                            <a class="list-item__link" href="https://youtu.be/dQw4w9WgXcQ">Додо-книга </a>
                        </li>
                        <li class="footer__list-item">
                            <a class="list-item__link" href="https://youtu.be/dQw4w9WgXcQ">Блог "Сила ума" </a>
                        </li>
                        <li class="footer__list-item">
                            <a class="list-item__link" href="https://youtu.be/dQw4w9WgXcQ">Додо ИС </a>
                        </li>
                    </ul>
                </div>

                <div class="footer__column">
                    <h3 class="footer__header">Работа</h3>
                    <ul class="footer__list">
                        <li class="footer__list-item">
                            <a class="list-item__link" href="https://youtu.be/dQw4w9WgXcQ">В пиццерии </a>
                        </li>
                        <li class="footer__list-item">
                            <a class="list-item__link" href="https://youtu.be/dQw4w9WgXcQ"
                                ><nobr>В контакт-центре</nobr></a
                            >
                        </li>
                    </ul>
                </div>
                ...
                <div class="footer__column">
                    <h3 class="footer__header">Партнерам</h3>
                    <ul class="footer__list">
                        <li class="footer__list-item">
                            <a class="list-item__link" href="https://youtu.be/dQw4w9WgXcQ">Франшиза </a>
                        </li>
                        <li class="footer__list-item">
                            <a class="list-item__link" href="https://youtu.be/dQw4w9WgXcQ">Инвестиции </a>
                        </li>
                        <li class="footer__list-item">
                            <a class="list-item__link" href="https://youtu.be/dQw4w9WgXcQ">Поставщикам </a>
                        </li>
                        <li class="footer__list-item">
                            <a class="list-item__link" href="https://youtu.be/dQw4w9WgXcQ">Предложить помещение </a>
                        </li>
                    </ul>
                </div>
                <div class="footer__column">
                    <h3 class="footer__header">Это интересно</h3>
                    <ul class="footer__list">
                        <li class="footer__list-item">
                            <a class="list-item__link" href="https://youtu.be/dQw4w9WgXcQ"
                        ...
                        <li class="footer__list-item">
                            <a class="list-item__link" href="https://youtu.be/dQw4w9WgXcQ">Корпоративные заказы </a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="right">
                <div class="app-container">
                    <a href="https://youtu.be/dQw4w9WgXcQ" class="app-link">
                        <svg width="120" height="40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#inline-svg-36-1)">
                                <path
        ...
        <div class="bottom">
            <div class="copyright">
                ...
                <span class="copyright__year">© 2021</span>
            </div>
            <div class="bottom__links">
                <a class="footer-link bottom-link" href="https://youtu.be/dQw4w9WgXcQ">Правовая информация </a>
                <a class="footer-link bottom-link" href="https://youtu.be/dQw4w9WgXcQ">Калорийность и состав</a>
                <a class="footer-link bottom-link" href="https://youtu.be/dQw4w9WgXcQ">Помощь</a>
            </div>
        </div>
    </div>
</footer>
